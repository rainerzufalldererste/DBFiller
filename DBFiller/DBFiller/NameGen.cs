...
namespace DBFiller
{
    public static class NameGen
    {
        ...
        public static string[] vornamenM = { "Ludwig ", "Berthold ", "Alois ", "Winfried ", "Otto ", "Gregor ", "Thomas ", "Johannes ", "Markus ", "Peter ", "Gerd ", "Tobias ", "Hans ", "Walther ", "Günther ", "Manfred ", "Pierre ", "Juan ", "Klaus ", "Fred ", "Antonio ", "Toni ", "Henry ", "Donald " };
        public static string[] vornamenW = { "Gudrun ", "Anette ", "Luise ", "Patrice ", "Waltraud ", "Anastasia ", "Julietta ", "Petra ", "Anna ", "Lisa ", "Mona ", "Augusta ", "Hanna ", "Sandra ", "Gundula ", "Claudia ", "Henrietta ", "Hillary " };
